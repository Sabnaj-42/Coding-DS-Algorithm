...
unordered_set<string> seen;//Unique element rakhbe,
                            // but sorted order a na. operation complexity O(n)
vector<int> edges;
...
int main()
{
    int n , k = 2;// k is the size of string A
    string A = "01";
    cin>>n;
